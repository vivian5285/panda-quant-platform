...
import { Copy, Check, Link2, Image, Download, Share2, QrCode } from 'lucide-react'
        ...
        <div className="invite-share-body">
          <div className="invite-share-main">
            ...
            <div className="invite-action-grid">
              ...
              <button type="button" className="btn btn-ghost" onClick={() => onCopy(data?.referral_code || '', 'code')}>
              ...
              <button type="button" className="btn btn-ghost invite-poster-btn" onClick={onGeneratePoster} disabled={posterLoading}>
