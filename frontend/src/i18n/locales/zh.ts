export default {
  ...
  referrals: {
    ...
    shareTitle: 'GEMINI AI · 双子星AI量化', shareText: 'AI 智能量化托管，邀请你一起加入！',
  ...
  legal: {
    privacy: {
      ...
      sections: {
        ...
        rights: { title: '6. 您的权利', body: '您可申请查阅、更正或删除账户信息（法律要求保留的交易/结算记录除外）。注销账户请联系 support@gemini-quant.com。' },
        contact: { title: '7. 联系我们', body: '隐私相关问题请发送邮件至 privacy@gemini-quant.com。我们将在合理时间内回复。' },
      },
    },
    terms: {
  ...
  saas: {
    ...
    stats: { kicker: '信任数据', title: '为什么选择双子星AI量化', users: '活跃用户', volume: '交易量', uptime: '可用性', orders: '已执行订单' },
    showcase: {
    ...
    footer: { tagline: '双子星AI量化 · GEMINI AI · 交易所 API 合作', product: '产品', legal: '法律', privacy: '隐私政策', terms: '服务条款', docs: '帮助文档', riskDisclaimer: '风险提示：加密货币交易具有高风险，过往业绩不代表未来收益。本平台不托管用户资金，不构成投资建议。' },
  },
  landing: {
    nav: {
      features: '核心优势', agents: 'AI 智能体', strategy: '策略体系', markets: '实时行情', how: '使用流程', security: '安全保障',
      stats: '平台数据', showcase: '产品展示', faq: '常见问题',
      console: '进入控制台',
    },
    ...
    agents: {
      ...
      subtitle: 'AI 智能体 24/7 监控信号、风控与结算 — 您通过交易所 API 保持完全控制权。',
    ...
    cta: {
      ...
      subtitle: '加入双子星AI量化，让策略在币安账户中 24 小时为您工作。',
      button: '立即注册',
    },
    footer: {
      tagline: '双子星AI量化 · GEMINI AI · 交易所 API 合作',
      rights: '© 2026 双子星AI量化 · GEMINI AI. All rights reserved.',
